...
- (void)loadLogData
{
    NSData *data = [NSData dataWithContentsOfFile:[[self.currentLogPathURL absoluteString] stringByReplacingOccurrencesOfString:@"file://" withString:@""]];
    ...
    [self.webView loadHTMLString:logString baseURL:nil];
