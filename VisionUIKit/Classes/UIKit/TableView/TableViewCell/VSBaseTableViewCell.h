...
@property (nonatomic, strong) Class          cellClass;                 //类的字符串名称
@property (nonatomic, strong) NSString          *identifier;            //Cell重用的识别标识
@property (nonatomic, strong) NSNumber          *height;                //Cell高度，默认Fit6P(135)
@property (nonatomic, weak)   UIViewController  *delegateController;            //指向所属的控制器
...
@protocol VSBaseTableViewCellProtocal <NSObject>
...
@end
@interface VSBaseTableViewCell : UITableViewCell
<VSBaseTableViewCellProtocal>
